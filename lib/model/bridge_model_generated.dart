...
class SignFileRequest {
  ...
  @override
  String toString() {
    return 'SignFileRequest{input: $input, publicKey: $publicKey, privateKey: $privateKey, passphrase: $passphrase, options: $options}';
  }
}
...
class KeyOptions {
  ...
  Hash get hash => Hash.fromValue(const fb.Int32Reader().vTableGet(_bc, _bcOffset, 4, 0));
  ///  Cipher is the cipher to be used.
  ///  If zero, AES-128 is used.
  Cipher get cipher => Cipher.fromValue(const fb.Int32Reader().vTableGet(_bc, _bcOffset, 6, 0));
  ///  Compression is the compression algorithm to be
  ///  applied to the plaintext before encryption. If zero, no
  ///  compression is done.
  Compression get compression => Compression.fromValue(const fb.Int32Reader().vTableGet(_bc, _bcOffset, 8, 0));
